...
export const ALL_DEMO_USERS = [
  { id: 1, name: 'Анна', age: 24, img: 'https://picsum.photos/seed/person_woman_1/600/800', hint: 'woman portrait', online: true, distance: 2, match: 87, city: 'Москва', zodiac: 'Лев', interests: ['Фотография', 'Путешествия', 'Кофе', 'Музыка', 'Спорт'], bio: 'Люблю закаты, хороший кофе и интересные разговоры.', height: 172, goal: 'Серьезные отношения', gender: 'female', lookingFor: 'male', superLikes: 5, boost: { boostedUntil: futureDate } },
  
  // 10 Men for Anna (Москва, совпадающие интересы и цели)
  { id: 2, name: 'Александр', age: 26, img: 'https://picsum.photos/seed/person_man_2/600/800', hint: 'man portrait', online: true, distance: 3, match: 95, city: 'Москва', zodiac: 'Овен', interests: ['Путешествия', 'Кофе', 'Спорт'], bio: 'Всегда в движении. Ищу ту, кто разделит мою страсть к горам и кофе.', height: 185, goal: 'Серьезные отношения', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null } },
  { id: 4, name: 'Михаил', age: 28, img: 'https://picsum.photos/seed/person_man_4/600/800', hint: 'man portrait', online: false, distance: 5, match: 89, city: 'Москва', zodiac: 'Скорпион', interests: ['Музыка', 'Кофе', 'Фотография'], bio: 'Играю на гитаре, варю лучший эспрессо. Давай сходим на концерт?', height: 182, goal: 'Свидания', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null } },
  { id: 6, name: 'Артем', age: 25, img: 'https://picsum.photos/seed/person_man_6/600/800', hint: 'man portrait', online: true, distance: 4, match: 84, city: 'Москва', zodiac: 'Близнецы', interests: ['Спорт', 'Музыка', 'Путешествия'], bio: 'Кодю днем, бегаю вечером. Люблю умные разговоры.', height: 178, goal: 'Новые друзья', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null } },
  { id: 8, name: 'Иван', age: 27, img: 'https://picsum.photos/seed/person_man_8/600/800', hint: 'man portrait', online: false, distance: 8, match: 91, city: 'Москва', zodiac: 'Стрелец', interests: ['Фотография', 'Путешествия', 'Спорт'], bio: 'Пейзажный фотограф. Мечтаю о поездке в Исландию.', height: 188, goal: 'Серьезные отношения', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null } },
  { id: 10, name: 'Никита', age: 30, img: 'https://picsum.photos/seed/person_man_10/600/800', hint: 'man portrait', online: false, distance: 6, match: 78, city: 'Москва', zodiac: 'Водолей', interests: ['Кофе', 'Музыка', 'Фотография'], bio: 'Ценю искренность и хороший юмор. Люблю открывать новые кофейни.', height: 180, goal: 'Просто общение', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null } },
  { id: 11, name: 'Дмитрий', age: 32, img: "https://picsum.photos/seed/person_man_11/600/800", hint: "man portrait", online: true, distance: 2, match: 92, city: 'Москва', zodiac: 'Телец', interests: ['Спорт', 'Кофе', 'Путешествия'], bio: 'Люблю активный отдых и продуктивные утра. Ищу серьезные отношения.', height: 184, goal: 'Серьезные отношения', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null } },
  { id: 12, name: 'Максим', age: 29, img: "https://picsum.photos/seed/person_man_12/600/800", hint: "man fashion", online: false, distance: 4, match: 86, city: 'Москва', zodiac: 'Козерог', interests: ['Музыка', 'Фотография', 'Спорт'], bio: 'Меломан и эстет. Люблю находить красоту в мелочах.', height: 179, goal: 'Свидания', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null } },
  { id: 13, name: 'Андрей', age: 31, img: "https://picsum.photos/seed/person_man_13/600/800", hint: "man professional", online: true, distance: 7, match: 83, city: 'Москва', zodiac: 'Весы', interests: ['Путешествия', 'Кофе', 'Музыка'], bio: 'Архитектор. Ищу вдохновение и интересного собеседника.', height: 181, goal: 'Новые друзья', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null } },
  { id: 14, name: 'Игорь', age: 24, img: "https://picsum.photos/seed/person_man_14/600/800", hint: "man fitness", online: true, distance: 1, match: 94, city: 'Москва', zodiac: 'Рак', interests: ['Спорт', 'Фотография', 'Путешествия'], bio: 'Жизнь — это приключение. Давай напишем свою историю вместе?', height: 176, goal: 'Серьезные отношения', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null } },
  { id: 15, name: 'Виктор', age: 35, img: "https://picsum.photos/seed/person_man_15/600/800", hint: "man intellectual", online: false, distance: 9, match: 81, city: 'Москва', zodiac: 'Дева', interests: ['Кофе', 'Музыка', 'Спорт'], bio: 'Спокойный, надежный, ценю уют и хороший джаз.', height: 183, goal: 'Свидания', gender: 'male', lookingFor: 'female', superLikes: 0, boost: { boostedUntil: null } },

  // Other Women
  { id: 3, name: 'Елена', age: 26, img: 'https://picsum.photos/seed/person_woman_3/600/800', hint: 'woman portrait', online: false, distance: 3, match: 81, city: 'Москва', zodiac: 'Рыбы', interests: ['Искусство', 'Чтение', 'Кулинария'], bio: 'Ищу кого-то, кто любит музеи и долгие прогулки.', height: 168, goal: 'Свидания', gender: 'female', lookingFor: 'male', superLikes: 0, boost: { boostedUntil: null } },
  { id: 5, name: 'София', age: 22, img: 'https://picsum.photos/seed/person_woman_5/600/800', hint: 'woman portrait', online: true, distance: 7, match: 88, city: 'Москва', zodiac: 'Дева', interests: ['Музыка', 'Творчество', 'Фотография'], bio: 'Мечтаю собрать свою группу и объехать мир.', height: 165, goal: 'Просто общение', gender: 'female', lookingFor: 'male', superLikes: 0, boost: { boostedUntil: null } },
  { id: 7, name: 'Мария', age: 29, img: 'https://picsum.photos/seed/person_woman_7/600/800', hint: 'woman portrait', online: true, distance: 1, match: 94, city: 'Москва', zodiac: 'Скорпион', interests: ['Йога', 'Природа', 'Путешествия'], bio: 'Люблю готовить полезную еду и ходить в походы.', height: 170, goal: 'Серьезные отношения', gender: 'female', lookingFor: 'male', superLikes: 0, boost: { boostedUntil: null } },
  { id: 9, name: 'Ксения', age: 23, img: 'https://picsum.photos/seed/person_woman_9/600/800', hint: 'woman portrait', online: true, distance: 6, match: 83, city: 'Москва', zodiac: 'Козерог', interests: ['Рукоделие', 'Дизайн', 'Искусство'], bio: 'Жизнь слишком коротка, чтобы носить скучную одежду.', height: 174, goal: 'Серьезные отношения', gender: 'female', lookingFor: 'male', superLikes: 0, boost: { boostedUntil: null } }
];
