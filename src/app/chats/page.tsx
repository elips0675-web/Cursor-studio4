...
function ChatsContent() {
  ...
  }, [matchId, language, loadIcebreakers]);
  ...
  if (selectedChat) {
    return (
      <div className="flex flex-col h-svh bg-[#f8f9fb]">
        ...
        {selectedChat && isVideoCall && <VideoCallDialog open={isVideoCall} onOpenChange={setIsVideoCall} user={selectedChat} />}
        {selectedChat && isVoiceCall && <VoiceCallDialog open={isVoiceCall} onOpenChange={setIsVoiceCall} user={selectedChat} />}
      </div>
    );
  }
