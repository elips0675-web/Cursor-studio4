    ...
    <div className="flex flex-col min-h-svh bg-[#f8f9fb]">
      ...
      <main className="flex-1 overflow-y-auto p-6 space-y-8">
        <header className="text-center space-y-4">
          <div className="inline-flex p-4 bg-white rounded-3xl app-shadow mb-2 border border-border/40">
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4">
            {techItems.map((item, idx) => (
              ...
              >
                <Card className="border-0 app-shadow bg-white rounded-3xl overflow-hidden">
        ...
        <section className="bg-primary/5 rounded-[2.5rem] p-8 border border-primary/10 text-center space-y-4">
